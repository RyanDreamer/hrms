		...
		<div class="header">
			<div class="top">
				...
				<ul class="nav">
					...
					<li><a href="/hrdb1/admin/dept.jsp">员工信息管理</a></li>
						...
						<div class="inner03">
							<div id="tabCot_product" class="zhutitab">
								...
								<div id="tabCot_product_1" class="tabCot">
									<form action="/hrdb1/ShowDeptServlet" method="post">
									...
									<form action="/hrdb1/AddDeptServlet" method="post">
									...
									<form action="/hrdb1/RmDeptServlet" method="post">
