...
IJobDao emp1 = new JobDaoImpl();
			...
			request.setAttribute("developementNum", developementNum);
			request.setAttribute("qualityNum", qualityNum);
			request.setAttribute("salesNum", salesNum);
			request.setAttribute("adminisNum", adminisNum);
			request.setAttribute("personnelNum", personnelNum);
			request.setAttribute("financeNum", financeNum);
