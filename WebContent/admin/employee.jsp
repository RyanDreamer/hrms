	...
	<div id="main">
		...
		<div class="header">
			<div class="top">
				...
				<ul class="nav">
					<li><a href="/hrms/adimin/首页.html">首页</a></li>
					<li><a href="/hrms/admin/部门管理.html">部门管理</a></li>
					<li><a href="/hrms/admin/岗位管理.html">岗位管理</a></li>
					<li class="seleli"><a href="#">员工信息管理</a></li>
					<li><a href="/hrms/admin/调动管理.html">调动管理</a></li>
					<li><a href="/hrms/admin/entry.jsp">入职管理</a></li>
					<li><a href="/hrms/admin/离职管理.html">离职管理</a></li>
				</ul>
			</div>
		</div>
						...
						<div class="inner03">
							<div id="tabCot_product" class="zhutitab">
								<div class="tabContainer">
									...
									<p class="shent">
										<span>Show entries: </span> <input style="width: 30px;"
											type="text" value="10"> <img src="images/sz.jpg"
											class="icon" style="">
									</p>
									<div class="clear"></div>
								</div>
								...
								<script language="JavaScript" type="text/javascript"
									src="<td>${staff.name }</td>js/tab.js"></script>
							</div>
						</div>
					</div>
				</div>
