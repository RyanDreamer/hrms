							...
							<div id="tabCot_product" class="zhutitab">
								...
								<div id="tabCot_product_1" class="tabCot">
									...
									<form action="/hrms/AddEmployee" method="post">
										添加员工：<br />
										<br /> <input type="text" placeholder="工号" name="eid" /> <input
											type="text" placeholder="姓名" name="name" /> <input
											type="text" placeholder="年龄" name="age" /> <input
											type="text" placeholder="性别" name="sex" /> <br /> <input
											type="text" placeholder="籍贯" name="hometown" /> <input
											type="text" placeholder="原职业" name="oldJob" /> <input
											type="text" placeholder="工作年数" name="experience" /> <input
											type="text" placeholder="学历" name="education" /> <br /> <input
											type="text" placeholder="是否通过cet4" name="cet4" /> <input
											type="text" placeholder="家庭成员人数" name="family" /> <input
											type="text" placeholder="密码" name="password" /> <br />
									...
									<form action="/hrms/RmEmployee" method="post">
										删除员工：<br />
										<br /> <input type="text" placeholder="工号" name="eid" /><br />
										<br /> <input type="submit" value="提交" /><br />
										<c:choose>
